...
const getImageName = (serviceType) => {
  const serviceImages = {
    портрет: 'portrait.svg',
    свадебная: 'wedding.svg',
    мода: 'fashion.svg',
    семейная: 'family.svg',
    мероприятие: 'event.svg',
    спорт: 'sport.svg'
  }
  return 'portrait.svg' // Можно добавить дефолтную картинку
}
  ...
  >
    <div class="flex flex-col">
      <div class="text-center">
        <img :src="`/${getImageName(title)}`" alt="" class="size-48 mx-auto" />
